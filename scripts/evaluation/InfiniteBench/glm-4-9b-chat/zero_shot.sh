...
python src/amzn_long_context_rag/evaluation/xfinder_eval_mcqa.py \
    --files "data/outputs/InfiniteBench/longbook_choice_eng/glm-4-9b-chat/zero_shot.jsonl" \
...
python src/amzn_long_context_rag/evaluation/infinitebench_eval.py \
    ...
    --file "data/outputs/InfiniteBench/longbook_qa_eng/glm-4-9b-chat/zero_shot.jsonl" \
...
python src/amzn_long_context_rag/evaluation/infinitebench_eval.py \
    ...
    --file "data/outputs/InfiniteBench/longbook_sum_eng/glm-4-9b-chat/zero_shot.jsonl" \
