...
export EXPERIMENT_NAME="qwen2_5_7b_instruct_1m_grpo_quote"
...
hotpot_qa_train_path="$DATA_DIR/train/hotpot_qa/grpo/train_quote.parquet"
hotpot_qa_test_path="$DATA_DIR/train/hotpot_qa/grpo/test_quote.parquet"
WikiMultihopQA_train_path="$DATA_DIR/train/2WikiMultihopQA/grpo/train_quote.parquet"
WikiMultihopQA_test_path="$DATA_DIR/train/2WikiMultihopQA/grpo/test_quote.parquet"

train_files="['$hotpot_qa_train_path', '$WikiMultihopQA_train_path']"
test_files="['$hotpot_qa_test_path', '$WikiMultihopQA_test_path']"

reward_func_name="my_reward_fn_quote"
