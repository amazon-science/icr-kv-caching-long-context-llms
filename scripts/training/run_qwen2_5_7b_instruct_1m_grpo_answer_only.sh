...
export EXPERIMENT_NAME="qwen2_5_7b_instruct_1m_grpo_answer_only"
...
hotpot_qa_train_path="$DATA_DIR/hotpot_qa/grpo/answer_only/train.parquet"
hotpot_qa_test_path="$DATA_DIR/hotpot_qa/grpo/answer_only/test.parquet"
WikiMultihopQA_train_path="$DATA_DIR/2WikiMultihopQA/grpo/answer_only/train.parquet"
WikiMultihopQA_test_path="$DATA_DIR/2WikiMultihopQA/grpo/answer_only/test.parquet"

train_files="['$hotpot_qa_train_path', '$WikiMultihopQA_train_path']"
test_files="['$hotpot_qa_test_path', '$WikiMultihopQA_test_path']"

reward_func_name="my_reward_fn_answer_only"
...
if [ "${HOSTNAME##*-}" -eq 0 ]; then
    ...
    python -m verl.trainer.main_ppo \
        ...
        data.shuffle=False \
        custom_reward_function.path=code/verl/verl/utils/reward_score/qa_grpo.py \
