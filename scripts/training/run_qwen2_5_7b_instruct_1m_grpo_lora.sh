...
export EXPERIMENT_NAME="qwen2_5_7b_instruct_1m_grpo_lora"
...
hotpot_qa_train_path="$DATA_DIR/hotpot_qa/grpo/train.parquet"
hotpot_qa_test_path="$DATA_DIR/hotpot_qa/grpo/test.parquet"
WikiMultihopQA_train_path="$DATA_DIR/2WikiMultihopQA/grpo/train.parquet"
WikiMultihopQA_test_path="$DATA_DIR/2WikiMultihopQA/grpo/test.parquet"
